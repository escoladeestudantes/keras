...
#Usar
#python facial-expression-recognition-from-stream_Sefik_Serengil.py
...
while(ret==True):
	...
	if ret==True:
		...
		for (x,y,w,h) in faces:
			...
			cv2.putText(img, emotion, (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 5)
			cv2.putText(img, emotion, (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
